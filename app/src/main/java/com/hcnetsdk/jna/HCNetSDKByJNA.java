...
//    }
	...
	public static class NET_DVR_LOCAL_GENERAL_CFG extends Structure {
		...
		protected List<String> getFieldOrder() {
			...
			return Arrays.asList("byExceptionCbDirectly", "byNotSplitRecordFile", "byResumeUpgradeEnable", "byAlarmJsonPictureSeparate",

					"byRes", "i64FileSize", "dwResumeUpgradeTimeout", "byRes1");
